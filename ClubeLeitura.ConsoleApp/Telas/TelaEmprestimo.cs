...
namespace ClubeLeitura.ConsoleApp.Telas
{
    public class TelaEmprestimo : TelaBase
    {
        ...
        public void RegistrarEmprestimo()
        {
            ...
            bool revistaEncontrada = controladorRevista.ExisteRevistaComEsteId(idRevista);
            ...
            bool amigoEncontrado = controladorAmigo.ExisteAmigoComEsteId(idAmigo);
            ...
            Amigo amigo = controladorAmigo.SelecionarAmigoPorId(idAmigo);
            Revista revista = controladorRevista.SelecionarRevistaPorId(idRevista);
